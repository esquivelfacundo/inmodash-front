...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    const cspHeader = [
      ...
      "font-src 'self' data:",
      "connect-src 'self' http://localhost:3001 http://127.0.0.1:3001 http://192.168.0.81:3001 https://inmodash-back-production.up.railway.app https://api.mercadopago.com https://api.mercadolibre.com https://www.mercadolibre.com https://www.mercadopago.com.ar", // Allow backend API, MercadoPago and MercadoLibre APIs, MercadoPago fingerprint
